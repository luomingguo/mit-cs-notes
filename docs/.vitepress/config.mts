    ...
    sidebar: {
      ...
      '/zh/os_engineering': [
        ...
        },
        {
          text: '操作系统工程',
          collapsed: false,
          link: "/zh/os_engineering/",
          items: [
            { text: "lec01 OS总览", link: "/zh/os_engineering/lec1" },
            { text: "lec02 C语言和内存抽象", link: "/zh/os_engineering/lec2" },
            { text: "lec03 OS设计", link: "/zh/os_engineering/lec3" },
            { text: "lec04 虚拟内存 & 页表", link: "/zh/os_engineering/lec4" },
            { text: "lec05 系统调用的Entry & Exit", link: "/zh/os_engineering/lec5" },
            { text: "lec06 RISV-V调用约定", link: "/zh/os_engineering/lec6" },
            { text: "lec07 页错误", link: "/zh/os_engineering/lec7" },
            { text: "lec08 xv6介绍", link: "/zh/os_engineering/lec8" },
            { text: "lec09 设备驱动 & 中断", link: "/zh/os_engineering/lec9" },
            { text: "lec10 锁", link: "/zh/os_engineering/lec10" },
            { text: "lec11 调度", link: "/zh/os_engineering/lec11" },
            { text: "lec13 协调(Sleep & wakeup)", link: "/zh/os_engineering/lec13" },
            { text: "lec12 文件系统", link: "/zh/os_engineering/lec12" },
            { text: "lec14 崩溃恢复 & 日志记录", link: "/zh/os_engineering/lec14" },
            { text: "lec15 Linux Ext3的崩溃恢复", link: "/zh/os_engineering/lec15" },
            { text: "lec16 用户级虚拟内存", link: "/zh/os_engineering/lec16" },
            { text: "lec17 OS的组织 & 微内核", link: "/zh/os_engineering/lec17" },
            { text: "lec18 虚拟机", link: "/zh/os_engineering/lec18" },
            { text: "lec19 内核与高级语言", link: "/zh/os_engineering/lec19" },
            { text: "lec20 网络与OS", link: "/zh/os_engineering/lec20" },
            { text: "lec21 熔断", link: "/zh/os_engineering/lec21" },
            { text: "lec22 多核可扩展性 & RCU", link: "/zh/os_engineering/lec22" },
          ]
        },
      ],
      '/zh/computer_sys_eng/': [
