...
- 加速比目标
  ...
  - ![截屏2024-04-01 15.08.31](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660a5d7b9ae57.png)
  - 线性增长的阻碍
...
- Shared Everything——共享所有
  ...
  - ![截屏2024-04-01 15.28.27](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660a6222ed112.png)
  - 优点
    - 容易构建多核计算机就是如此，易于编程
    - 多线程执行
    - 每个核都能访问任何记录
...
- Shared-Disk——共享磁盘
  ...
  - ![截屏2024-04-01 15.28.43](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660a6231ed2ca.png)
  - 多机器；每个机器都能访问磁盘的任何记录
...
- Shared-Nothing——分布式
  ...
  - ![截屏2024-04-01 15.48.22](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660a66cd1a84b.png)
  - 多机器
...
- Shared-Nothing——基于分布式文件系统的分布式
  ...
  ![截屏2024-04-02 12.05.23](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660b840b21d99.png)
...
- 流水线并行： 不同的线程执行各自的操作
  ...
  - ![截屏2024-04-02 12.35.37](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660b8b2020798.png)

- 分区并行：不同的处理器处理每个分区
  - ![截屏2024-08-20 10.17.42](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c3fccf6e60b.png)
...
- 随机/轮转分区
  - ![截屏2024-08-20 11.03.59](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c407a5ce19d.png)
...
- 范围分区
  - ![截屏2024-08-20 11.04.24](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c407c17544f.png)
  - 当表根据连接属性被分区好了后，允许我们用连接而无需重新分区
  - 优点：容易下推谓词（根据分区的属性）
  - 缺点：
    - 难以保证等量的分区，特别是插
- Hash分区
  - ![截屏2024-08-20 11.13.37](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c409ea2954c.png)
  - 当表根据连接属性被分区好了后，允许我们用连接而无需重新分区
...
![截屏2024-08-20 12.25.14](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c41ab2a5fcf.png)
...
![截屏2024-04-02 14.50.05](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/660baaa60715c.png)
...
![截屏2024-08-20 12.27.59](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c41b589ac75.png)
...
- ![截屏2024-08-20 12.59.16](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c422afa3ddb.png)
...
![截屏2024-08-20 14.40.34](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c43a690a2aa.png)
