...
1. $T_i$在$T_j$开始读取阶段之前完成了其写入阶段，即$W(T_i) \prec R(T_j)$ 
   ...
   ![截屏2024-08-20 08.05.11](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66c3ddc0b8ce4.png)

   在$T_j$开始读阶段时， $T_i$已经完成它的写阶段，他们**没有任何重叠**

2. $W(T_j)$与$R(T_i)$不相交，并且$W(T_i) \prec W(T_j)$

   ![截屏2024-08-20 08.06.33](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6845dac16568c.png)
...
![截屏2024-07-19 16.29.06](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/669a23e18a7ad.png)
...
![截屏2024-08-28 10.23.59](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/68465e9cc143d.png)
