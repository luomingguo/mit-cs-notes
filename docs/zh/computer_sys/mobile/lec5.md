...
<div style="border-left: 4px solid #4a90d9; background: #eaf2fb; padding: 10px 15px; margin: 10px 0; border-radius: 4px;"><strong>定义 — 三角困境</strong><br>
带宽、覆盖范围、功耗三者相互制约，无法同时最优。Wi-Fi 带宽大但耗电；LoRaWAN 覆盖远且省电但带宽极小；BLE 介于中间。</div>
...
<div style="border-left: 4px solid #e05c5c; background: #fdeeee; padding: 10px 15px; margin: 10px 0; border-radius: 4px;"><strong>例题 — AirTag 电池寿命估算</strong></div>
...
<div style="border-left: 4px solid #5cb85c; background: #eafaf0; padding: 10px 15px; margin: 10px 0; border-radius: 4px;"><strong>推论 — 占空比是低功耗的核心武器</strong>　将占空比从 100% 降至 0.1% 可使平均功耗降低约 1000 倍，这是 BLE 能以纽扣电池运行数年的根本原因。</div>

---

## 3. LoRaWAN — 长距离低功耗广域网

<div style="border-left: 4px solid #4a90d9; background: #eaf2fb; padding: 10px 15px; margin: 10px 0; border-radius: 4px;"><strong>定义 — LoRa（<em>Long Range</em>）</strong><br>
使用扩频调制（<em>Chirp Spread Spectrum, CSS</em>），以极低功耗实现 2–15 km 传输距离，代价是极低的数据速率（数百 bps）和有限的每日数据量。</div>
...
<div style="border-left: 4px solid #5cb85c; background: #eafaf0; padding: 10px 15px; margin: 10px 0; border-radius: 4px;"><strong>推论 — 安全与隐私的双面性</strong>　AirTag 的设计在方便用户追踪自己物品的同时，也引发了被恶意用于跟踪他人的安全顾虑，是 IoT 设计中隐私与功能权衡的典型案例。</div>
