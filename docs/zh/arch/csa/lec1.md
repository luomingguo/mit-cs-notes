...
![截屏2024-06-24 11.01.52](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6678e1ab52c1e.png)
...
![截屏2024-06-24 00.10.26](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667848fdeffb8.png)
...
![截屏2024-06-24 11.02.24](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6678e1c8957fb.png)

**单累加器机器**

![截屏2024-06-24 11.30.03](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6678e8418a811.png)

解释：

1. LOOP: 加载N，即当前循环的计数器
2. JGE DONE: 检查N是否>=0,如果是跳转DONE，结束
3. ADD ONE：将1加到N
4. STORE N: 存储更新后的N
5. F1: LOAD A, 加载Ai。
6. F1: ADD B，进行加法运算将A
...
![截屏2024-06-24 11.30.03](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6678eb0ddba4e.png)
...
>  LOADi x, IX // IX <- M[x] (截断以适应IX)
>  ```
>
>  PC是程序计数器（Program Counter），用于指示当前执行的指令地址。
>
...
![截屏2024-06-24 13.41.31](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66790711b235b.png)

**分析** 

![截屏2024-06-24 13.41.10](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667906fdb7056.png)
...
一开始， IX看起来像个累加器， 后面引入多个索引寄存器和多个累加器，这样可以同时处理更多的数据和地址需求，再后来就索引寄存器和累加器的功能开始融合，就演变成了通用寄存器。

----

**如何支持子例程调用**

![截屏2024-06-24 13.50.45](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6679093b37085.png)
