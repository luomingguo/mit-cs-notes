...
# Lec 5 从 C 到汇编语言（基于 LLVM)

本节课我们将探讨如何 C 如何用 x86-64 的汇编实现的
...
在 Lec 5 我们介绍了从 C 语言如何经过 LLVM IR 生成汇编语言的，这节我们将探讨 LLVM IR 和汇编的
...
这节课关于内存的分配和释放。文献中就叫做 Storage Allocation
