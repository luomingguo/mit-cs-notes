...
type: lecture
lecture: 11
tags: [user-centered-design, user-research, ideation, prototyping, usability-testing]
status: complete
---
# Lec 11 原型和用户测试
...
- 以用户为中心的设计通过反复发现需求、产生方案、制作原型和测试来降低方向错误的成本。
- 需求发现关注真实用户、任务与环境，想法产生阶段则应先扩大方案空间，再收敛到可验证假设。
- 原型可分别控制深度、广度、外观与交互保真度；Wizard of Oz 方法还能在后端能力实现前验证体验。
...
::: insight
原型最重要的产物不是界面，而是被验证或推翻的假设。保真度应由当前问题决定：若只验证流程，过早追求视觉精度反而会让团队忽视结构性风险。
:::
