...
type: lecture
lecture: 4
tags: [visual-design, contrast, alignment, proximity, visual-hierarchy]
status: draft
---
# Lec 4 图形设计（TD）
...
- 图形设计服务于信息理解与任务完成，不能被简化为在功能完成后添加装饰。
- 对比、重复、对齐与邻近通过差异和分组建立视觉层级，使相关信息更容易被扫描和理解。
- 源笔记在“简单性”处中断，因此关于如何减少无效视觉元素的内容仍待补充。
