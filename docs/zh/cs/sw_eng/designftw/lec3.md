...
type: lecture
lecture: 3
tags: [learnability, information-architecture, affordance, feedback, conceptual-model]
status: complete
---
# Lec 3 可学习性（TD）
...
- 可学习性取决于界面能否支持用户目标，而不只是让控件看起来熟悉；信息架构与信息气味帮助用户判断下一步。
- 可供性、指示物和及时反馈把可执行动作及其结果外显，减少试错成本与不确定性。
- 识别通常比回忆轻松，稳定的概念模型、术语和隐喻一致性能够降低长期记忆负担。
...
::: insight
降低学习成本的核心不是把所有功能都摆在眼前，而是让用户在每一步都能预测“这里能做什么、做完会发生什么”。信息气味和反馈共同维持这种可预测性。
:::
