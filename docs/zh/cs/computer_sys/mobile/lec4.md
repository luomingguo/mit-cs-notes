...
::: theorem 推论 — 距离分辨率
距离分辨率 $\Delta d = c/(2B)$，带宽 $B = 1.79$ GHz 对应约 8.4 cm 的分辨率，足以感知人体运动。
:::
...
::: theorem 推论
呼吸频率约 0.1–0.5 Hz，心跳约 1–2 Hz，FMCW 的慢时间维（帧间）FFT 可以分离出这两个频率成分，用于生命体征检测（*Vital Sign Detection*）。
:::
