...
![截屏2024-06-29 16.05.13](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667fc04f6e3ee.png)
...
![截屏2024-06-29 17.56.05](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667fda42422f0.png)
...
![截屏2024-06-29 18.26.23](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667fe17699a23.png)
...
![截屏2024-06-29 18.57.44](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667fe8afd971c.png)
...
![截屏2024-06-29 19.35.13](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667ff17d8f10e.png)
...
![截屏2024-06-29 19.40.22](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667ff2c426509.png)
...
![截屏2024-06-29 19.44.15](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667ff39ce8ef0.png)
...
![截屏2024-06-29 19.53.28](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667ff5c75a025.png)
...
![截屏2024-06-29 20.19.23](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667ffbd5120ae.png)

----

**x86-64 数据类型**

![截屏2024-06-29 20.23.58](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/667ffcec71be9.png)
...
![截屏2024-06-30 11.09.33](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6680cc7695e86.png)

---

**条件码**

![截屏2024-06-30 11.10.53](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6680ccc49e9f1.png)
...
-  **基址-索引-比例-位移** x86-64 支持的最通用的间接寻址模式是基址-索引-比例-位移模式。该模式指的是地址 `Base + Index*Scale + Displacement`。 如果未指定，索引和位移默认值为 0，比例默认值为 1
  - ![截屏2024-06-30 23.59.04](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66818c74a9c16.png)
...
![截屏2024-07-01 00.12.06](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66818c660c6f8.png)
...
![截屏2024-07-01 01.04.16](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819018f1551.png)

**SSE操作码后缀**

SSE指令使用了两字母后缀来编码数据类型

![截屏2024-07-01 01.04.59](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681904365b8b.png)
...
![截屏2024-07-01 01.17.49](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819344a46f1.png)
...
![截屏2024-07-01 01.35.23](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/668197654e2dd.png)
...
![截屏2024-07-01 01.49.00](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819a91dd695.png)
...
![截屏2024-07-01 01.50.46](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819afbe7801.png)
...
![截屏2024-07-01 01.52.35](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819b6b2b294.png)

 用块状图表示5阶段处理器

![截屏2024-07-01 01.53.47](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819bb1ee147.png)
...
![截屏2024-07-01 01.55.05](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/66819c0109d87.png)
...
![截屏2024-07-01 02.41.11](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681a6cdc51d0.png)

**实际中的流水线执行**

在实际操作中，各种问题可能会阻止一条指令在其指定的周期内执行，导致处理器流水线停顿(stall)。

![截屏2024-07-01 02.41.43](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681a6f06f0da.png)
...
![截屏2024-07-01 02.57.11](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681aa8ed1962.png)一些算数操作在硬件实现上很复杂，并且有很长的延迟。硬件如何完成上面的操作的呢？ 
...
![截屏2024-07-01 03.02.14](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681abbe9182b.png)
...
![截屏2024-07-01 03.09.03](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681ad561c90f.png)

**Intel Haswell的取指和解码**

![截屏2024-07-01 03.11.45](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681ae59265d6.png)
...
![截屏2024-07-01 03.17.05](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681af396f92d.png)
...
![截屏2024-07-01 03.20.16](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681aff6b0a84.png)

在cycle5 to 6之间，会发生停顿，为了等待%rax写到一个寄存器内。

**使用旁路技术情况**

![截屏2024-07-01 03.21.49](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b0533e024.png)

**硬件还可以利用ILP做什么呢？**

我们来看下面的代码

![截屏2024-07-01 03.24.13](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b0e377008.png)

我们发现这里存在真实依赖，

![截屏2024-07-01 03.25.18](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b124378e5.png)

反依赖

![截屏2024-07-01 03.26.20](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b1628c5d7.png)
...
![截屏2024-07-01 03.27.30](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b1a968449.png)

**数据流图**

我们可以将数据依赖建模称数据流图

![截屏2024-07-01 03.40.50](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b4fb4d252.png)
...
![截屏2024-07-01 03.48.20](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b68c10f45.png)

对于WAR， 我们可以通过重命名寄存器。重命名寄存器的主要思想是将逻辑寄存器映射到物理寄存器，以确保每条指令有自己独立的物理寄存器， 从而消除依赖关系



![截屏2024-07-01 03.48.02](https://tc-1258979383.cos.ap-guangzhou.myqcloud.com/6681b6809070c.png)
